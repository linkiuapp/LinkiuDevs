<x-tenant-admin-layout :store="$store">
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <!-- Formulario -->
        <form action="{{ route('tenant.admin.sliders.update', [$store->slug, $slider->id]) }}" method="POST" enctype="multipart/form-data" x-data="sliderForm" class="space-y-6">
            @csrf
            @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select name="transition_duration" 
                                ...
                                <option value="7" {{ old('transition_duration', $slider->transition_duration) == '7' ? 'selected' : '' }}>7 segundos</option>
                            </select>
                        </div>
                    </div>
            ...
            <div class="bg-white-50 rounded-lg p-0 overflow-hidden">
                <div class="p-6">
                    ...
                    <div class="border-2 border-dashed border-white-200 rounded-lg p-6 text-center" x-data="{ imagePreview: '{{ $slider->image_path ? asset('storage/' . $slider->image_path) : null }}' }">
                    ...
                    @enderror
                    <p class="text-xs text-black-300 mt-2">Deja vacío para mantener la imagen actual</p>
                </div>
            </div>
