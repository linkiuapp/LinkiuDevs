<x-tenant-admin-layout :store="$store">
    ...
    @section('content')
        ...
        <!-- Tabs Navigation -->
        <div class="bg-white-50 rounded-lg overflow-hidden p-6">
            ...
            <div class="p-6">
                ...
                <div id="content-owner" class="tab-content">
                    <form action="{{ route('tenant.admin.business-profile.update-owner', ['store' => $store->slug]) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="owner_name" value="{{ old('owner_name', auth()->user()->name) }}" 
                                       class="w-full px-3 py-2 border border-white-200 rounded-md focus:outline-none focus:ring-2 focus:ring-primary-200">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <select name="owner_document_type" class="w-full px-3 py-2 border border-white-200 rounded-md focus:outline-none focus:ring-2 focus:ring-primary-200">
                        ...
                        <div class="mt-6">
                            <button type="submit" class="bg-primary-200 text-white-50 px-6 py-2 rounded-md hover:bg-primary-300 transition-colors">
                                Guardar Cambios
                            </button>
                        </div>
                    </form>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" value="{{ $store->slug }}" readonly
                                       class="w-full px-3 py-2 border border-white-200 rounded-md bg-white-100 text-black-300">
                            </div>
                            <div class="md:col-span-2">
                                <label class="block text-sm font-medium text-black-400 mb-2">Descripción</label>
                                <textarea name="description" rows="3" 
                                          class="w-full px-3 py-2 border border-white-200 rounded-md focus:outline-none focus:ring-2 focus:ring-primary-200">{{ old('description', $store->description) }}</textarea>
                            </div>
                            <div>
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <textarea name="meta_description" rows="3" 
                                          class="w-full px-3 py-2 border border-white-200 rounded-md focus:outline-none focus:ring-2 focus:ring-primary-200">{{ old('meta_description', $store->meta_description) }}</textarea>
                            </div>
                            <div>
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <textarea name="privacy_policy" rows="4" 
                                          class="w-full px-3 py-2 border border-white-200 rounded-md focus:outline-none focus:ring-2 focus:ring-primary-200">{{ old('privacy_policy', $policies->privacy_policy) }}</textarea>
                            </div>
                            <div>
                                ...
                                <textarea name="terms_conditions" rows="4" 
                                          class="w-full px-3 py-2 border border-white-200 rounded-md focus:outline-none focus:ring-2 focus:ring-primary-200">{{ old('terms_conditions', $policies->terms_conditions) }}</textarea>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-black-400 mb-2">Política de Envíos</label>
                                <textarea name="shipping_policy" rows="4" 
                                          class="w-full px-3 py-2 border border-white-200 rounded-md focus:outline-none focus:ring-2 focus:ring-primary-200">{{ old('shipping_policy', $policies->shipping_policy) }}</textarea>
                            </div>
                            <div>
                                ...
                                <textarea name="return_policy" rows="4" 
                                          class="w-full px-3 py-2 border border-white-200 rounded-md focus:outline-none focus:ring-2 focus:ring-primary-200">{{ old('return_policy', $policies->return_policy) }}</textarea>
                            </div>
                        </div>
                        <div class="mt-6">
                            <button type="submit" class="bg-primary-200 text-white-50 px-6 py-2 rounded-md hover:bg-primary-300 transition-colors">
                    ...
                    <form action="{{ route('tenant.admin.business-profile.update-about', ['store' => $store->slug]) }}" method="POST">
                        ...
                        <div>
                            ...
                            <textarea name="about_us" rows="6" 
                                      class="w-full px-3 py-2 border border-white-200 rounded-md focus:outline-none focus:ring-2 focus:ring-primary-200">{{ old('about_us', $policies->about_us) }}</textarea>
                        </div>
                        <div class="mt-6">
                            <button type="submit" class="bg-primary-200 text-white-50 px-6 py-2 rounded-md hover:bg-primary-300 transition-colors">
                                Guardar Cambios
