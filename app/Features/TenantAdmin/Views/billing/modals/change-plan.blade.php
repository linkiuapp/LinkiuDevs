                ...
                <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="plan_change_reason" 
                                  x-model="reason"
                                  rows="3"
                                  class="w-full px-3 py-2 border border-white-200 rounded-lg focus:ring-2 focus:ring-primary-200 focus:border-primary-300 text-sm text-black-500 placeholder-black-200"
            ...
            <div class="border-t border-white-100 px-6 py-4">
                <div class="flex gap-3 justify-end">
                    ...
                    <button @click="changePlan()" 
                            ...
                            class="px-4 py-2 bg-primary-300 text-white-50 text-sm rounded-lg hover:bg-primary-400 transition-colors">
