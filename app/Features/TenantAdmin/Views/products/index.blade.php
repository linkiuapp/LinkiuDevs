    ...
    <div x-data="productManagement" class="space-y-4">
        ...
        <div class="bg-white-50 rounded-lg p-0 overflow-hidden">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" 
                                   ...
                                   class="pl-10 pr-4 py-1.5 border border-white-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-200">
                        </div>
                        
                        <!-- Acciones masivas -->
                        <div x-show="selectedProducts.length > 0" class="flex items-center gap-2">
                            <button @click="bulkActivate()" 
                                    class="px-3 py-1.5 bg-success-400 text-white-50 rounded-lg text-sm hover:bg-success-300 flex items-center gap-1">
                            ...
                            <button @click="bulkDelete()" 
                                    class="px-3 py-1.5 bg-error-400 text-white-50 rounded-lg text-sm hover:bg-error-300 flex items-center gap-1">
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    <thead>
                        <tr class="bg-white-100 border-b border-white-200">
                            <th class="px-6 py-3 text-left">
                                <input type="checkbox" 
                                       @change="toggleAll($event.target.checked)"
                                       class="rounded border-white-300">
                            </th>
                    ...
                    <tbody class="bg-white-50 divide-y divide-white-200">
                        @forelse($products as $product)
                            <tr class="text-black-400 hover:bg-white-100" data-id="{{ $product->id }}">
                                <td class="px-6 py-4">
                                    <input type="checkbox" 
                                           class="product-checkbox rounded border-white-300" 
                                           value="{{ $product->id }}"
                                           @change="toggleProduct({{ $product->id }}, $event.target.checked)">
                                </td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center text-sm">
                                        <div class="w-12 h-12 mr-3 flex items-center justify-center bg-white-100 rounded-lg overflow-hidden">
                ...
                <div x-show="showDuplicateModal"
                    ...
                    <div class="bg-white-100 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                        <button type="button" 
                                ...
                                class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-secondary-300 text-base font-medium text-white-50 hover:bg-secondary-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-secondary-300 sm:ml-3 sm:w-auto sm:text-sm">
                            Duplicar
                        </button>
                        <button type="button" 
                                @click="closeDuplicateModal()"
                                class="mt-3 w-full inline-flex justify-center rounded-md border border-white-300 shadow-sm px-4 py-2 bg-white-50 text-base font-medium text-black-400 hover:bg-white-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-300 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
                            Cancelar
                        </button>
                    </div>
                </div>
