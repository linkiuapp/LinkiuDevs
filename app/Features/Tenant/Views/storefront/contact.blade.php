...
<div class="p-4 space-y-6">
    ...
    <div class="space-y-3">
        ...
        <nav class="flex text-sm text-black-300">
            ...
            <span class="text-black-400 font-medium">Contacto</span>
        </nav>
        
        <!-- Title -->
        <h1 class="text-lg font-bold text-black-400">Nuestras Sedes</h1>
        <p class="text-black-200">Encuentra la sede más cercana a ti</p>
    </div>
    ...
    @else
        <!-- Estado vacío -->
        <div class="bg-white-50 rounded-xl p-8 text-center border border-white-200">
            <div class="w-16 h-16 bg-white-200 rounded-full flex items-center justify-center mx-auto mb-4">
                <x-solar-buildings-outline class="w-8 h-8 text-black-300" />
            </div>
            <h3 class="text-lg font-semibold text-black-400 mb-2">Próximamente</h3>
            <p class="text-black-300 text-sm mb-4">Estamos trabajando en agregar nuestras sedes</p>
            @if($store->phone || $store->email)
                <div class="space-y-2">
                    @if($store->phone)
                        <a href="tel:{{ $store->phone }}" 
                           class="inline-flex items-center gap-2 bg-primary-300 text-white-50 px-4 py-2 rounded-lg text-sm hover:bg-primary-200 transition-colors">
                    ...
                    @if($store->email)
                        <a href="mailto:{{ $store->email }}" 
                           class="inline-flex items-center gap-2 bg-white-200 text-black-400 px-4 py-2 rounded-lg text-sm hover:bg-white-300 transition-colors">
